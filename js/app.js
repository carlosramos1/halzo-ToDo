...
for(let task of listTasksPending) {
  addArticleTaskPending(task)
}

for (let task of listTasksDone) {
 ...
 * Feature: boton done
 */
var pendingTasks = document.querySelectorAll('#listTasksPending .task');

for (let articleTask of pendingTasks) {
